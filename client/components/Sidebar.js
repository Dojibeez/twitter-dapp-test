...
import ProfileImageMinter from './mintingModal/ProfileImageMinter.tsx';
...
const style = {
    ...
    navContainer: `flex-1`,
    profileButton: `flex items-center mb-6 cursor-pointer hover:bg-[#333645] rounded-[100px] p-2`,
...
const Sidebar = ({ initialSelectedIcon = 'Explore' }) => {
